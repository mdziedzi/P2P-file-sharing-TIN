...
public class RemoteNodesController {
    ...
    public void onNewDataReceived(DeserializedObject receivedData, RemoteNode remoteNode) {
        if (receivedData.isConnectionRequest()) {
            passwordHashOfNetwork.equals(receivedData.getPasswordHash());
        }
    }
}
